...
####### SECTION 5.2.1 #######
## claude code: rmse_mat_er_0.9_1stag → rmse_mat[,1:3] and rmse_mat_1stag → rmse_mat
...
rmse_all_df <- data.frame("1"=c(rmse_mat[,4],rmse_mat[,5]),"2"=c(rmse_mat_2stag[,3],rmse_mat_2stag[,4]),
